...
.method private constructor <init>(Lgnu/kawa/swingviews/SwingContent;Lgnu/expr/Language;Lgnu/mapping/Environment;Z)V
    ...
    .line 79
    new-instance p1, Lkawa/ReplPaneOutPort;

    sget-object v0, Lkawa/ReplDocument;->defaultStyle:Ljavax/swing/text/Style;

    const-string v1, "/dev/stdout"

    invoke-direct {p1, p0, v1, v0}, Lkawa/ReplPaneOutPort;-><init>(Lkawa/ReplDocument;Ljava/lang/String;Ljavax/swing/text/AttributeSet;)V

    iput-object p1, p0, Lkawa/ReplDocument;->out_stream:Lkawa/ReplPaneOutPort;
    ...
    iput-object p1, p0, Lkawa/ReplDocument;->err_stream:Lkawa/ReplPaneOutPort;

    .line 81
    new-instance p1, Lkawa/GuiInPort;
    ...
    invoke-direct {p1, v0, v1, v2, p0}, Lkawa/GuiInPort;-><init>(Ljava/io/Reader;Lgnu/text/Path;Lgnu/mapping/OutPort;Lkawa/ReplDocument;)V

    iput-object p1, p0, Lkawa/ReplDocument;->in_p:Lkawa/GuiInPort;
    ...
    iget-object p2, p0, Lkawa/ReplDocument;->in_p:Lkawa/GuiInPort;

    iget-object p4, p0, Lkawa/ReplDocument;->out_stream:Lkawa/ReplPaneOutPort;

    iget-object v0, p0, Lkawa/ReplDocument;->err_stream:Lkawa/ReplPaneOutPort;

    invoke-static {p1, p3, p2, p4, v0}, Lgnu/mapping/Future;->make(Lgnu/mapping/Procedure;Lgnu/mapping/Environment;Lgnu/mapping/InPort;Lgnu/mapping/OutPort;Lgnu/mapping/OutPort;)Lgnu/mapping/Future;
...
.method public declared-synchronized textValueChanged(Ljavax/swing/event/DocumentEvent;)V
    ...
    .line 227
    iget p1, p0, Lkawa/ReplDocument;->endMark:I
