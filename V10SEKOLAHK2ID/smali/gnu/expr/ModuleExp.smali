...
.method public static evalToClass(Lgnu/expr/Compilation;Ljava/net/URL;)Ljava/lang/Class;
    ...
    sget-object v4, Lgnu/expr/ModuleExp;->dumpZipPrefix:Ljava/lang/String;

    invoke-direct {p1, v4}, Ljava/lang/StringBuffer;-><init>(Ljava/lang/String;)V

    .line 70
    sget v4, Lgnu/expr/ModuleExp;->lastZipCounter:I

    add-int/2addr v4, v3

    sput v4, Lgnu/expr/ModuleExp;->lastZipCounter:I
    ...
    .line 72
    sget v4, Lgnu/expr/ModuleExp;->interactiveCounter:I
    ...
    .line 96
    invoke-virtual {v8, v4}, Ljava/util/zip/ZipEntry;->setMethod(I)V

    .line 97
    invoke-virtual {p1, v8}, Ljava/util/zip/ZipOutputStream;->putNextEntry(Ljava/util/zip/ZipEntry;)V

    .line 98
    invoke-virtual {p1, v6}, Ljava/util/zip/ZipOutputStream;->write([B)V
    ...
    .line 116
    :goto_2
    invoke-virtual {p1}, Lgnu/bytecode/ArrayClassLoader;->getParent()Ljava/lang/ClassLoader;
    ...
    check-cast p1, Lgnu/bytecode/ArrayClassLoader;
    ...
    .line 131
    invoke-virtual {p1, v8}, Lgnu/bytecode/ArrayClassLoader;->addClass(Ljava/lang/Class;)V
    ...
    .line 135
    invoke-virtual {p1, v6}, Lgnu/expr/ModuleInfo;->setModuleClass(Ljava/lang/Class;)V

    .line 136
    invoke-virtual {p0}, Lgnu/expr/Compilation;->cleanupAfterCompilation()V

    .line 137
    iget v1, p1, Lgnu/expr/ModuleInfo;->numDependencies:I

    :goto_5
    if-ge v4, v1, :cond_c

    .line 141
    iget-object v3, p1, Lgnu/expr/ModuleInfo;->dependencies:[Lgnu/expr/ModuleInfo;

    aget-object v3, v3, v4

    .line 142
    invoke-virtual {v3}, Lgnu/expr/ModuleInfo;->getModuleClassRaw()Ljava/lang/Class;
    ...
    invoke-static {v3, v2}, Lgnu/expr/ModuleExp;->evalToClass(Lgnu/expr/Compilation;Ljava/net/URL;)Ljava/lang/Class;

    move-result-object v5

    .line 145
    :cond_b
    iget-object v3, p0, Lgnu/expr/Compilation;->loader:Lgnu/bytecode/ArrayClassLoader;

    invoke-virtual {v3, v5}, Lgnu/bytecode/ArrayClassLoader;->addClass(Ljava/lang/Class;)V
    :try_end_0
